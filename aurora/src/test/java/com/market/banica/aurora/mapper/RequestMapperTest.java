...
class RequestMapperTest {
    ...
    public static final Aurora.AuroraRequest MARKET_SELL_PENDING_PRODUCT_REQUEST = Aurora.AuroraRequest.newBuilder().setTopic("market-europe/sell/eggs/2.50/2").build();
    ...
    void renderRequestWithSellProductRequestForMarketToSellTheProductToMarket() throws IOException, ServiceNotFoundException {
        ...
        //Act
        Aurora.AuroraResponse actual = requestMapper.renderRequest(MARKET_SELL_PENDING_PRODUCT_REQUEST);
