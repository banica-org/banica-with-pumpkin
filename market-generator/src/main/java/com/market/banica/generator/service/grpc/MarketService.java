...
public class MarketService extends MarketServiceGrpc.MarketServiceImplBase {
    ...
    private void addDummyData() {
        ...
        marketState.addGoodToState("water", 5.0, 400, millis);
        marketState.addGoodToState("tomatoes", 5.0, 70, millis);
        marketState.addGoodToState("milk", 5.0, 3, millis);
        marketState.addGoodToState("pumpkin", 5.0, 400, millis);
        marketState.addGoodToState("sugar", 5.0, 60, millis);
    }
